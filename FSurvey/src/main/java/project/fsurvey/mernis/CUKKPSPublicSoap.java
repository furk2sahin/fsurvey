...
public class CUKKPSPublicSoap
{
    ...
    public CUKKPSPublicSoap(){}

    public CUKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CUKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CUKExtendedSoapSerializationEnvelope envelope= new CUKExtendedSoapSerializationEnvelope(CUKExtendedSoapSerializationEnvelope.VER11);
