...
public class CUKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CUKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CUKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CUKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CUKDateTimeConverter dateTimeConverter = new CUKStandardDateTimeConverter();

    public CUKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CUKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CUKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CUKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CUKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CUKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
